      ...
      input: [
        {
          role: "system",
          content:
            "You extract travel documents into structured data. CRITICAL: copy day summaries and activity text VERBATIM from the source — never rewrite, polish, or generate new content. Translate Chinese to Mongolian. Never invent contacts.",
        },
        {
          role: "user",
