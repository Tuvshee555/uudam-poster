...
- For "summary": copy the program/хөтөлбөр text for that day WORD FOR WORD from the source. If the source has no paragraph text for that day, use "" (empty string). DO NOT write a single word that is not in the source document.
- For "activities": copy bullet points or sentences from the source exactly. Do not add, remove, or change any words.
